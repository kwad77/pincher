...
// TestClaudeMD_SchemaVersionParity was removed in the CLAUDE.md
// slim-down (commits 10fdbdd → bc6e517). The canonical schema-version
// claim now lives only in docs/reference/architecture.md, which
// TestReferenceMD_SchemaVersionParity above already pins. CLAUDE.md
// no longer carries duplicate architecture content, so a parallel
// guard on it has no surface to gate.
