...
curl -L -o pincher.tar.gz https://github.com/kwad77/pincher/releases/download/v1.5.0/pincher-v1.5.0-linux-amd64.tar.gz
tar -xzf pincher.tar.gz && sudo mv pincher-v1.5.0-linux-amd64 /usr/local/bin/pincher
