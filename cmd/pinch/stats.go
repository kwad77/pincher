...
type StatsReport struct {
	...
	// have returned. Nil (omitted) when no redirect carries the v40
...
func buildStatsReport(store *db.Store, dir string) (*StatsReport, error) {
	...
	// v40 baseline telemetry, so the section never shows a meaningless
...
func formatStatsText(r *StatsReport) string {
	...
	// carry the v40 savings telemetry — fresh / pre-upgrade installs
